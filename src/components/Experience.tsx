...
export const Experience = () => {
  return (
    ...
    >
      <img src={gifBackground} alt="anime-girl" className="absolute z-0 left-0 bottom-0 h-full" />
      <h1 className="dark:text-white text-center mt-20 text-6xl font-bold">
        Experience
      </h1>
          ...
          {listExperience.map(({ title, date, location, toDo }, index) => (
            <div
              ...
              <div className="flex flex-col w-1/3 relative">
                <span className="bg-purple-400 text-center py-0.5 font-bold rounded-full mr-3 text-white hover:scale-105 transition-all cursor-pointer">{date}</span>
              ...
              <div className="px-5 pb-5 border-l-2 border-purple-500 w-2/3">
                <span className="text-lg font-bold">{title} - {location}</span>
